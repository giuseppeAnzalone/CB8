...
navBarEl.append(logoAndSearchEl(), menuGenEl());

const mainSectionEl = document.querySelector(".main");

mainSectionEl.appendChild(modalElGen());
...
asyncListContainerElGen("/movie/popular", "Movies - Popular").then((element) =>
  modalEl.append(element)
);
